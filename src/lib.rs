...
// Article: https://crypto.stackexchange.com/a/22719/108601
// Constants: https://datatracker.ietf.org/doc/rfc3526/?include_text=1
// h = pow(g, 847283748237482374283748192839128391829381920839128, p)
...
mod tests {
    ...
    fn test_constants() {
        ...
        let x = &BigUint::from_bytes_be(&hex::decode("129192929292abababab").unwrap()); // secret
